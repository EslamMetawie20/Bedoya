    ...
    <PageTransition>
      ...
      <div ref={heroRef} className="relative h-screen w-full overflow-hidden flex items-center justify-center bg-black">
        ...
        <motion.div
          ...
          className="absolute inset-0 z-0 bg-[url('/src/assets/projects/city-facade/render_1.jpg')] bg-cover bg-center brightness-[0.3]"
        />
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="aspect-[4/5] overflow-hidden bg-luxury-dark border border-white/5 shadow-2xl relative group">
              <img
                src="/src/assets/projects/mens-majlis/render_1.jpg"
      ...
      <section id="contact" className="bg-luxury-dark py-24 md:py-36 relative border-t border-white/5">
        <div className="absolute inset-0 bg-[url('/src/assets/projects/library-room/render_3.jpg')] bg-cover bg-center opacity-[0.03]" />
